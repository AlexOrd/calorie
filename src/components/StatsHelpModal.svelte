    ...
    >
      ...
      {#snippet hydrationBody()}
        <p class="text-fg/90 text-sm">
          ...
          страйк до денного вердикту. Гідрація тепер показана тим самим календарем по днях тижня, що
          й інші секції.
        </p>
        <ul class="text-fg/90 ml-4 list-none space-y-1 text-sm">
          <li class="flex items-center gap-2">
      ...
      {#snippet calendarBody()}
        <p class="text-fg/90 text-sm">
          У статистиці всі квадрати означають одне й те саме: один квадрат = один день, вирівняний
          по днях тижня. Усі три календарі показують останні 90 днів: енергобаланс, категорії та
          гідрацію.
        </p>
        <ul class="text-fg/90 ml-4 list-none space-y-1 text-sm">
          <li class="flex items-center gap-2">
        ...
        <p class="text-muted text-xs">
          Контуром позначено сьогодні, а перше число місяця має внутрішню обводку.
        </p>
      {/snippet}
      ...
      {#snippet projectionBody()}
        <p class="text-fg/90 text-sm">
          Прогноз цілі поєднує тренд калорій і фактичний тренд зі зважувань. Якщо обидва ведуть до
          цілі — пунктир зелений; якщо ні — червоний.
        </p>
      {/snippet}
