...
<section class="flex flex-col gap-4 p-2 md:p-4">
  ...
  <button
    type="button"
    onclick={openHelp}
    class="text-muted hover:text-fg border-border bg-surface-2 mx-auto mt-2 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm transition-colors"
  >
    <HelpCircle size={16} />
